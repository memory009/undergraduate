...
def sensor_callback(sensor_data, sensor_queue, sensor_name):
    if 'lidar' in sensor_name:
        sensor_data.save_to_disk(os.path.join('../outputs/lidar_synchronized', '%06d.ply' % sensor_data.frame))
    if 'camera' in sensor_name:
        sensor_data.save_to_disk(os.path.join('../outputs/camera_synchronized', '%06d.png' % sensor_data.frame))
...
def main():
    ...
    try:
        ...
        output_path_1 = '../outputs/lidar_synchronized'
        if not os.path.exists(output_path_1):
            os.makedirs(output_path_1)

        output_path_2 = '../outputs/camera_synchronized'
